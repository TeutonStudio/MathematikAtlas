...
object MathematikKnotenVorlagen {
    ...
    val Division = KnotenVorlage(
        "mathematik.division", "Division", "Rechnen", "Teilt Dividend durch Divisor und verwendet bei Divisor 0 den dritten Eingang.", GraphGröße(245f, 145f),
        listOf(
    ...
    val Darstellungsoptimierung = KnotenVorlage(
        ...
        listOf(
            eingang("wert", MathematikAnschlussArten.Objekt.id),
            AnschlussDaten(
                name = "wert",
    ...
    val Fall = KnotenVorlage(
        "mathematik.fall", "Fallunterscheidung", "Steuerung", "Wählt abhängig vom Wahrheitswert einer Aussage einen von zwei Werten und vereinigt deren Anschlussarten.", GraphGröße(260f, 150f),
        listOf(
