...
object LineareAlgebraGrundlagenKnotenVorlagen {
    ...
    val alle = listOf(Vektorraum,LineareAbbildung)+SkalarproduktKnotenVorlagen.alle+HyperAnalysisKnotenVorlagen.alle+DifferentialKnotenVorlagen.alle+IntegralKnotenVorlagen.alle+StrukturFormelRechnerVorlagen.alle+eigenschaftsVorlagen
}
