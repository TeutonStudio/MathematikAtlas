...
class MengenObjektAnschluss(
    graph: Graph,
    daten: MengenAnschlussDaten,
    ...
    class MengenAnschlussDaten(
        ...
        override fun erlaubeVerbindung(mit: GraphDatenAnschluss): Boolean =
            super.erlaubeVerbindung(mit) && mit is MengenAnschlussDaten
    ...
    companion object {
        const val ANSCHLUSS_ART: AnschlussArt = "menge"
        const val EINGANG_ART: AnschlussArt = "menge-eingang"
        const val AUSGANG_ART: AnschlussArt = "menge-ausgang"
        const val UNBEKANNT = "?"
    }
}
