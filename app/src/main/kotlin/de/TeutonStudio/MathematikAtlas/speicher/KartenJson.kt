...
import de.TeutonStudio.MathematikKnoten.migriereAlgebraischePotenzKnoten
import org.json.JSONObject

/** App-Fassade: reiner Codec im Verwalter, App-spezifische Migration anschließend. */
object KartenJson {
    fun schreibe(karte: KartenDaten): String =
        KartenDatenJson.schreibe(karte.migriereAlgebraischePotenzKnoten())
    ...
    fun lese(json: JSONObject): KartenDaten = KartenDatenJson.lese(json)
        ...
        .migriereAlgebraischePotenzKnoten()
}
